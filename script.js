...
class TodoList {
  constructor(todosContainer) {
    ...
    // Ambil counter terakhir dari localStorage atau mulai dari 1
    this.counter = parseInt(localStorage.getItem("todoCounter")) || 1;
  ...
  addNewTodo(newTodotitle) {
    if (newTodotitle) {
      ...
      this.counter++; // counter terus bertambah
      this.saveToLocalStorage("todos", this.todos);
      localStorage.setItem("todoCounter", this.counter); // Simpan counter terbaru
      this.addTodosToDom();
    }
  }
